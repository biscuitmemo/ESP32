...
lv_obj_t *ui_Button1;
lv_obj_t *ui_Button2;
lv_obj_t *ui_LabelHomeTitle;
lv_obj_t *ui_LabelHomeCurrent;
lv_obj_t *ui_LabelHomeSet;
lv_obj_t *ui_LabelHomeMode;
lv_obj_t *ui_LabelHomeHint;
lv_obj_t *ui_LabelHomeAction;
